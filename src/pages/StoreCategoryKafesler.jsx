...
export default function StoreCategoryKafesler() {
    ...
    <>
      <div style={{padding:40}} className={styles.storePage}>
        <div style={{display:'flex',alignItems:'center',gap:16,marginBottom:24,justifyContent:'space-between'}}>
          <BackButton />
          <h1 style={{color:'#f7882f',fontWeight:800,fontSize:32,margin:0,flex:1,textAlign:'center'}}>Kafesler ve Barınaklar</h1>
        </div>
