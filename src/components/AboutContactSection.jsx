...
export default function AboutContactSection() {
  return (
    <div style={{
      ...
      <div>
        <div style={{ fontWeight: 700, fontSize: '1.3rem', marginBottom: '0.2rem', color: '#fff', textShadow: '0 2px 8px rgba(0,0,0,0.45)' }}>OUR STORY</div>
        <div style={{ color: '#F7882F', fontWeight: 900, fontSize: '2.5rem', fontStyle: 'italic', marginBottom: '1.2rem', textShadow: '0 2px 12px rgba(0,0,0,0.45)' }}>About Us</div>
      ...
      <div>
        <div style={{ fontWeight: 700, fontSize: '1.2rem', marginBottom: '0.2rem', color: '#fff', textShadow: '0 2px 8px rgba(0,0,0,0.45)' }}>DON'T MISS OUT</div>
        <div style={{ color: '#F7882F', fontWeight: 900, fontSize: '2.5rem', fontStyle: 'italic', marginBottom: '1.2rem', textShadow: '0 2px 12px rgba(0,0,0,0.45)' }}>Contact us</div>
      ...
      <div style={{ color: '#fff', fontSize: '1.1rem', marginBottom: '1rem', textShadow: '0 2px 8px rgba(0,0,0,0.45)' }}>
        © 2023 Atakum Kavurmacısı. Tüm hakları saklıdır.
      </div>
    </div>
  );
} 